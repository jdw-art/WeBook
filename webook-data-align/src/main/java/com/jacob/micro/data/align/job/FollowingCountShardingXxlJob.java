...
import com.jacob.micro.data.align.domain.mapper.SelectRecordMapper;
import com.jacob.micro.data.align.domain.mapper.UpdateRecordMapper;
...
public class FollowingCountShardingXxlJob {
    ...
    @Resource
    private SelectRecordMapper selectMapper;

    @Resource
    private UpdateRecordMapper updateMapper;
