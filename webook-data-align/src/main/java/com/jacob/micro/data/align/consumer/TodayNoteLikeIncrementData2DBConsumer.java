package com.jacob.micro.data.align.consumer;

import com.jacob.micro.data.align.constant.MQConstants;
import com.jacob.micro.data.align.constant.RedisKeyConstants;
import com.jacob.micro.data.align.constant.TableConstants;
import com.jacob.micro.data.align.domain.mapper.InsertRecordMapper;
import com.jacob.micro.data.align.model.dto.LikeUnlikeNoteMqDTO;
 ...
 * @Date: 2025/1/23 15:30
 * @Version: 1.0
 */
@Component
@RocketMQMessageListener(consumerGroup = "webook_group_data_align_" + MQConstants.TOPIC_COUNT_NOTE_LIKE, // Group 组
...
public class TodayNoteLikeIncrementData2DBConsumer implements RocketMQListener<String> {
    ...
    public void onMessage(String body) {
        ...
        if (Objects.equals(result, 0L)) {
            ...
            // 根据分片总数，取模，获取对应的分片序号
            long noteIdHashKey = noteId % tableShares;
        ...
        if (Objects.equals(result, 0L)) {
            ...
            // 根据分片总数，取模，获取对应的分片序号
            long userIdHashKey = noteCreatorId % tableShares;
