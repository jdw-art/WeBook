...
import com.jacob.micro.data.align.domain.mapper.DeleteTableMapper;
import com.jacob.micro.data.align.domain.mapper.InsertRecordMapper;
import com.jacob.micro.data.align.model.dto.NoteOperateMqDTO;
 ...
 * @Date: 2025/1/23 16:06
 * @Version: 1.0
 */
@Component
@RocketMQMessageListener(consumerGroup = "webook_group_data_align_" + MQConstants.TOPIC_NOTE_OPERATE, // Group 组
