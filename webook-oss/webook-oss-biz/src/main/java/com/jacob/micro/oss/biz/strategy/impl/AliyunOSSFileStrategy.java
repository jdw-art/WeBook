...
import com.jacob.micro.oss.biz.config.AliyunOSSProperties;
...
public class AliyunOSSFileStrategy implements FileStrategy {
    ...
    public String uploadFile(MultipartFile file) {
        ...
        // 上传文件至阿里云 OSS
        ossClient.putObject(aliyunOSSProperties.getBucketName(), objectName, new ByteArrayInputStream(file.getInputStream().readAllBytes()));
