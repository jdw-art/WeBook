...
import com.jacob.micro.user.relation.biz.enums.FollowUnfollowTypeEnum;
import com.jacob.micro.user.relation.biz.model.dto.CountFollowUnfollowMqDTO;
...
public class FollowUnfollowConsumer implements RocketMQListener<Message> {
    ...
    private void sendMQ(CountFollowUnfollowMqDTO countFollowUnfollowMqDTO) {
        // 构建消息对象，并将 DTO 转换成 Json 字符串设置到消息体中
