...
import com.jacob.micro.count.biz.domain.mapper.NoteCountDOMapper;
 ...
 * @Date: 2025/1/21 16:23
 * @Version: 1.0
 */
@Component
@RocketMQMessageListener(consumerGroup = "webook_group_" + MQConstants.TOPIC_COUNT_NOTE_LIKE_2_DB, // Group 组
