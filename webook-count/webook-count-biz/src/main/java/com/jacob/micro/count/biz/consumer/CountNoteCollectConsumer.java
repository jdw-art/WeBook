...
import com.jacob.micro.count.biz.enums.CollectUnCollectNoteTypeEnum;
import com.jacob.micro.count.biz.model.dto.CountCollectUnCollectNoteMqDTO;
 ...
 */
@Component
@RocketMQMessageListener(consumerGroup = "webook_group_" + MQConstants.TOPIC_COUNT_NOTE_COLLECT, // Group 组
