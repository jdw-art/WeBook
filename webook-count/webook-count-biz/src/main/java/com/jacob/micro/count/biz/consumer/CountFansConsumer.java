...
import com.jacob.micro.count.biz.enums.FollowUnfollowTypeEnum;
import com.jacob.micro.count.biz.model.dto.CountFollowUnfollowMqDTO;
        ...
        for (Map.Entry<Long, List<CountFollowUnfollowMqDTO>> entry : groupMap.entrySet()) {
            ...
            for (CountFollowUnfollowMqDTO countFollowUnfollowMqDTO : list) {
                ...
                switch (followUnfollowTypeEnum) {
                    ...
                    case UNFOLLOW -> finalCount -= 1; // 如果为取消关注操作，粉丝数 - 1
