...
import com.jacob.micro.count.biz.constant.RedisKeyConstants;
import com.jacob.micro.count.biz.enums.LikeUnlikeNoteTypeEnum;
import com.jacob.micro.count.biz.model.dto.AggregationCountLikeUnlikeNoteMqDTO;
import com.jacob.micro.count.biz.model.dto.CountLikeUnlikeNoteMqDTO;
 ...
 */
@Component
@RocketMQMessageListener(consumerGroup = "webook_group_" + MQConstants.TOPIC_COUNT_NOTE_LIKE, // Group 组
